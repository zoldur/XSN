...
CONFIGFOLDER='/root/.xsncore'
COIN_DAEMON='xsnd'
COIN_CLI='xsn-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/X9Developers/XSN/releases/download/v1.0.6/xsncore-1.0.6-linux64.tar.gz'
...
function create_key() {
  ...
  if [ "$?" -gt "0" ];
   ...
   rm -r $CONFIGFOLDER/{db.log,peers.dat,fee_estimates.dat,banlist.dat,database,mncache.dat,mnpayments.dat,netfulfilled.dat,merchantnodecache.dat,governance.dat,blocks,chainstate,debug.log}
  fi
  clear
}
